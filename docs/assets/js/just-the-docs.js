(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://angelarwang.com/dendron-notes/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://angelarwang.com/dendron-notes/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://angelarwang.com/dendron-notes/assets/css/just-the-docs-' + theme + ".css"
      );
    };
